...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://sacredtrails.evelyn-ai.com/guide/camino-de-santiago' },
}
    ...
    <>
      ...
      <article className="max-w-4xl mx-auto px-4 py-12">
        ...
        <section className="mb-10">
          ...
          <p className="text-stone-600 leading-relaxed mb-4">
            In 2025, more than 530,000 pilgrims received the Compostela certificate — a record number, and 90% more than a decade ago. The routes span multiple countries, crossing the Pyrenees from France, climbing the Atlantic coast of Spain, threading through Portugal, and following ancient Roman roads from Seville. The UNESCO World Heritage–listed network of trails is alive with centuries of history, community, and personal transformation.
          </p>
