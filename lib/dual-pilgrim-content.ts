...
const en: DualPilgrimContent = {
  ...
  kumanoRoutes: [
    ...
    { name: 'Kumano Nachi Taisha ↔ Kumano Hongu Taisha', distance: '~30 km · 2 days', note: 'Walk between Nachi and Hongu in either direction.' },
    { name: 'Nakahechi: Hosshinmon-oji → Kumano Hongu Taisha', distance: '~7 km · 2–3 hours', note: 'Also requires visits to Kumano Hayatama Taisha and Kumano Nachi Taisha.' },
    { name: 'Kohechi: Koyasan → Kumano Hongu Taisha', distance: '~65 km · 4 days', note: 'Mountain route connecting the two great Buddhist centres.' },
    { name: 'Ohechi stamp option', distance: 'Site-based · variable', note: 'Ogigahama Mizugori Site, Tokei-jinja, any two Ohechi sites, and all three Grand Shrines.' },
  ],
  ...
  faq: [
    ...
    { q: 'Do I need to walk the Nakahechi specifically?', a: 'No. Current official Kumano options include Takijiri-oji to Hongu, Nachi to/from Hongu, Hosshinmon-oji to Hongu plus Hayatama and Nachi, Koyasan to Hongu, or the official Ohechi stamp option. Iseji is not listed as a qualifying Dual Pilgrim option.' },
...
const ja: DualPilgrimContent = {
  ...
  kumanoRoutes: [
    ...
    { name: '熊野那智大社 ↔ 熊野本宮大社', distance: '約30km・2日', note: '那智と本宮の間をどちらの方向に歩いても対象。' },
    { name: '中辺路：発心門王子 → 熊野本宮大社', distance: '約7km・2〜3時間', note: '熊野速玉大社と熊野那智大社の参拝も必要。' },
    { name: '小辺路：高野山 → 熊野本宮大社', distance: '約65km・4日', note: '真言宗の聖地・高野山と熊野を結ぶ山岳路。' },
    { name: '大辺路スタンプ条件', distance: '地点指定・距離は可変', note: '扇ヶ浜潮垢離場、鬪雞神社、大辺路2か所以上、熊野三山すべてが必要。' },
  ],
  ...
  faq: [
    ...
    { q: '必ず中辺路を歩かなければいけない？', a: 'いいえ。現在の公式条件では、滝尻王子〜本宮、那智〜本宮、発心門王子〜本宮＋速玉・那智、高野山〜本宮、または大辺路の公式スタンプ条件が対象です。伊勢路はDual Pilgrimの対象条件には記載されていません。' },
...
const zhTW: DualPilgrimContent = {
  ...
  kumanoRoutes: [
    ...
    { name: '熊野那智大社 ↔ 熊野本宮大社', distance: '約 30 公里・2 天', note: '那智與本宮之間雙向徒步皆可。' },
    { name: '中邊路：發心門王子 → 熊野本宮大社', distance: '約 7 公里・2–3 小時', note: '另需參拜熊野速玉大社與熊野那智大社。' },
    { name: '小邊路：高野山 → 熊野本宮大社', distance: '約 65 公里・4 天', note: '連接真言宗聖地高野山與熊野的山岳路。' },
    { name: '大邊路印章條件', distance: '指定地點・距離不固定', note: '須完成扇濱潮垢離場、鬪雞神社、至少兩處大邊路地點，以及熊野三山全部印章。' },
  ],
  ...
  faq: [
    ...
    { q: '一定要走中邊路嗎？', a: '不用。目前官方熊野條件包含瀧尻王子到本宮、那智到/從本宮、發心門王子到本宮加速玉與那智、高野山到本宮，或大邊路官方印章條件。伊勢路未列為 Dual Pilgrim 資格選項。' },
...
const es: DualPilgrimContent = {
  ...
  kumanoRoutes: [
    ...
    { name: 'Kumano Nachi Taisha ↔ Kumano Hongu Taisha', distance: '~30 km · 2 días', note: 'Caminar entre Nachi y Hongu en cualquiera de las dos direcciones.' },
    { name: 'Nakahechi: Hosshinmon-oji → Kumano Hongu Taisha', distance: '~7 km · 2–3 horas', note: 'También requiere visitar Kumano Hayatama Taisha y Kumano Nachi Taisha.' },
    { name: 'Kohechi: Koyasan → Kumano Hongu Taisha', distance: '~65 km · 4 días', note: 'Ruta de montaña que conecta los dos grandes centros budistas.' },
    { name: 'Opción de sellos Ohechi', distance: 'Por sitios · variable', note: 'Ogigahama Mizugori, Tokei-jinja, dos sitios Ohechi cualesquiera y los tres Grandes Santuarios.' },
  ],
  ...
  faq: [
    ...
    { q: '¿Debo caminar obligatoriamente el Nakahechi?', a: 'No. Las opciones oficiales actuales de Kumano incluyen Takijiri-oji a Hongu, Nachi hacia/desde Hongu, Hosshinmon-oji a Hongu más Hayatama y Nachi, Koyasan a Hongu, o la opción oficial de sellos Ohechi. Iseji no aparece como opción válida Dual Pilgrim.' },
